...
def bhattacharyya_distance(mean1, var1, mean2, var2):
    ...
    # First term: variance term
    term1 = 0.25 * np.log(0.25 * (var1/var2 + var2/var1 + 2))
    
    # Second term: mean difference term
...
# Calculate Bhattacharyya Distance for all 64 dimensions
...
# Find Best and Worst based on Bhattacharyya Distance
...
# ===================================================================
# Problem c(ii): Use 8 best features (selected by Bhattacharyya Distance)
# ===================================================================
print("\n" + "=" * 60)
